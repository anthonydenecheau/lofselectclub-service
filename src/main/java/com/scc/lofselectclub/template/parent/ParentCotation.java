...
public class ParentCotation {
	...
	public ParentCotation withGrade(int grade){ this.setGrade(grade); return this; }
	public ParentCotation withQtity(int qtity){ this.setQtity(qtity); return this; }
	public ParentCotation withPercentage(String percentage){ this.setPercentage(percentage); return this; }
