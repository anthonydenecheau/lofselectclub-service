...
public class HealthServiceController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Successfully retrieved Health"),
    ...
    public HealthResponseObject gethHealthStatisticsByIdClub(@ApiParam(value = "id club", required = true) @PathVariable("id") int id) throws EntityNotFoundException {
