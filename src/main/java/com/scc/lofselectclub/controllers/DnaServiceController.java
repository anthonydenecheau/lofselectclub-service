...
import com.scc.lofselectclub.services.DnaService;
...
public class DnaServiceController {
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Successfully retrieved Dna"),
    ...
    public DnaResponseObject getDnaStatisticsByIdClub(@ApiParam(value = "id club", required = true) @PathVariable("id") int id) throws EntityNotFoundException {
