...
public class ConsanguinityServiceController {
	...
	@ApiResponses(value = { @ApiResponse(code = 200, message = "Successfully retrieved Consanguinity"),
	...
	public ConsanguinityResponseObject getConsanguinityStatisticsByIdClub(
