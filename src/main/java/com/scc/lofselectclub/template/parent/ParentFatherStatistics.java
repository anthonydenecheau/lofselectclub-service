...
//	List<AffixVariety> variety;
	...
	public List<ParentFather> getFathers() { return fathers; }
	public void setFathers(List<ParentFather> fathers) { this.fathers = fathers; }

//	public List<AffixVariety> getVariety() { return variety; }
//	public void setVariety(List<AffixVariety> variety) { this.variety = variety; }

	public ParentFatherStatistics withYear(int year){ this.setYear(year); return this; }
	public ParentFatherStatistics withFathers(List<ParentFather> fathers){ this.setFathers(fathers); return this; }
//	public FatherStatistics withVariety(List<AffixVariety> variety){ this.setVariety(variety); return this; }
