...
public class ConfirmationResponseObject {
	...
	public List<ConfirmationBreed> getBreeds() { return breeds; }
	public void setBreeds(List<ConfirmationBreed> breeds) { this.breeds = breeds; }

	public ConfirmationResponseObject withSize(int size){ this.setSize(size); return this; }
	public ConfirmationResponseObject withBreeds(List<ConfirmationBreed> breeds){ this.setBreeds(breeds); return this; }
