...
public class BirthResponseObject {
	...
	public List<BirthBreed> getBreeds() { return breeds; }
	public void setBreeds(List<BirthBreed> breeds) { this.breeds = breeds; }

	public BirthResponseObject withSize(int size){ this.setSize(size); return this; }
	public BirthResponseObject withBreeds(List<BirthBreed> breeds){ this.setBreeds(breeds); return this; }
