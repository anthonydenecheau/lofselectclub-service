...
public class BirthCotation {
	...
	public BirthCotation withGrade(int grade){ this.setGrade(grade); return this; }
	public BirthCotation withQtity(int qtity){ this.setQtity(qtity); return this; }
	public BirthCotation withPercentage(String percentage){ this.setPercentage(percentage); return this; }
