...
public class HealthStatistics {
	...
	public String getCodeSupraMaladie() { return codeSupraMaladie; }
	public void setCodeSupraMaladie(String codeSupraMaladie) { this.codeSupraMaladie = codeSupraMaladie; }

	public String getLibelleSupraMaladie() { return libelleSupraMaladie; }
	public void setLibelleSupraMaladie(String libelleSupraMaladie) { this.libelleSupraMaladie = libelleSupraMaladie; }

	public String getCodeMaladie() { return codeMaladie; }
	public void setCodeMaladie(String codeMaladie) { this.codeMaladie = codeMaladie; 	}

	public String getLibelleMaladie() { return libelleMaladie; }
	public void setLibelleMaladie(String libelleMaladie) { this.libelleMaladie = libelleMaladie; 	}

	public Integer getNatureSuivi() { return natureSuivi; }
	public void setNatureSuivi(Integer natureSuivi) { this.natureSuivi = natureSuivi; }
	...
	public String getLibelleResultat() { return libelleResultat; }
	public void setLibelleResultat(String libelleResultat) { this.libelleResultat = libelleResultat; }

	public Integer getNbResultat() { return nbResultat; }
	public void setNbResultat(Integer nbResultat) { this.nbResultat = nbResultat; }
	...
	public String toString() {
		return "HealthStatistics [idClub=" + idClub + ", nomClub=" + nomClub + ", numClub=" + numClub + ", idRace="
				...
				+ ", nomVariete=" + nomVariete + ", idMaladie=" + idMaladie + ", codeSupraMaladie=" + codeSupraMaladie
				+ ", libelleSupraMaladie=" + libelleSupraMaladie + ", codeMaladie=" + codeMaladie + ", libelleMaladie="
				+ libelleMaladie + ", natureSuivi=" + natureSuivi + ", codeResultat=" + codeResultat
				+ ", libelleResultat=" + libelleResultat + ", nbResultat=" + nbResultat + ", annee=" + annee + ", mois="
				+ mois + "]";
	}
