...
ALTER TABLE IF EXISTS ls_stats_eleveur ADD COLUMN IF NOT EXISTS nom_race_etalon varchar(80);
ALTER TABLE IF EXISTS ls_stats_eleveur ADD COLUMN IF NOT EXISTS nom_variete_etalon varchar(80);
