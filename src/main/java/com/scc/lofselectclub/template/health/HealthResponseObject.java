...
public class HealthResponseObject {
   ...
   public List<HealthBreed> getBreeds() {
      return breeds;
   }

   public void setBreeds(List<HealthBreed> breeds) {
      this.breeds = breeds;
   }

   public HealthResponseObject withSize(int size) {
      this.setSize(size);
      return this;
   }

   public HealthResponseObject withBreeds(List<HealthBreed> breeds) {
