...
public class BreederResponseObject {
	...
	public List<BreederBreed> getBreeds() { return breeds; }
	public void setBreeds(List<BreederBreed> breeds) { this.breeds = breeds; }

	public BreederResponseObject withSize(int size){ this.setSize(size); return this; }
	public BreederResponseObject withBreeds(List<BreederBreed> breeds){ this.setBreeds(breeds); return this; }
