...
ALTER TABLE IF EXISTS ls_stats_eleveur ADD COLUMN IF NOT EXISTS nom_race_etalon character varchar(80) COLLATE pg_catalog."default";
ALTER TABLE IF EXISTS ls_stats_eleveur ADD COLUMN IF NOT EXISTS nom_variete_etalon character varchar(80) COLLATE pg_catalog."default";
