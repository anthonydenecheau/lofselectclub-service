...
public class DnaStatistics {
	...
	public Integer getDna() { return dna; }
	public void setDna(Integer dna) { this.dna = dna; }

	public Integer getDnaComp() { return dnaComp; }
	public void setDnaComp(Integer dnaComp) { this.dnaComp = dnaComp; }

	public Integer getDnaCompP() { return dnaCompP; }
	public void setDnaCompP(Integer dnaCompP) { this.dnaCompP = dnaCompP; }

	public Integer getDnaCompM() { return dnaCompM; }
	public void setDnaCompM(Integer dnaCompM) { this.dnaCompM = dnaCompM; }
	...
	public String toString() {
		return "BirthStatistics [idClub=" + idClub + ", nomClub=" + nomClub + ", numClub=" + numClub + ", idRace="
				...
				+ ", nomVariete=" + nomVariete + ", dna=" + dna + ", dnaComp=" + dnaComp + ", dnaCompP="
				+ dnaCompP + ", dnaCompM=" + dnaCompM 
