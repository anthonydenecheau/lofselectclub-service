...
public class HealthVarietyStatistics {
	...
	public HealthVarietyStatistics withQtity(int qtity){ this.setQtity(qtity); return this; }
	public HealthVarietyStatistics withPercentage(String percentage){ this.setPercentage(percentage); return this; }
}
