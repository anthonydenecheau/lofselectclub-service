...
public class ConfirmationBreedStatistics {
	...
	public List<ConfirmationVariety> getVariety() { return variety; }
	public void setVariety(List<ConfirmationVariety> variety) { this.variety = variety; }

	public ConfirmationBreedStatistics withYear(int year){ this.setYear(year); return this; }
	public ConfirmationBreedStatistics withQtity(int qtity){ this.setQtity(qtity); return this; }
	public ConfirmationBreedStatistics withAvgHeight(int avgHeight){ this.setAvgHeight(avgHeight); return this; }
	public ConfirmationBreedStatistics withSeries(List<Map<String, Object>> series){ this.setSeries(series); return this; }
	public ConfirmationBreedStatistics withVariety(List<ConfirmationVariety> variety){ this.setVariety(variety); return this; }
