...
public class ParentGender {
	...
	public List<ParentRegisterType> getRegisterType() { return registerType; }
	public void setRegisterType(List<ParentRegisterType> registerType) { this.registerType = registerType; }

	public ParentGender withQtity(int qtity){ this.setQtity(qtity); return this; }
	public ParentGender withRegisterType(List<ParentRegisterType> registerType){ this.setRegisterType(registerType); return this; }
