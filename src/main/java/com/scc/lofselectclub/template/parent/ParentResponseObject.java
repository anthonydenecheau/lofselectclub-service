...
public class ParentResponseObject {
	...
	public List<ParentBreed> getBreeds() { return breeds; }
	public void setBreeds(List<ParentBreed> breeds) { this.breeds = breeds; }

	public ParentResponseObject withSize(int size){ this.setSize(size); return this; }
	public ParentResponseObject withBreeds(List<ParentBreed> breeds){ this.setBreeds(breeds); return this; }
