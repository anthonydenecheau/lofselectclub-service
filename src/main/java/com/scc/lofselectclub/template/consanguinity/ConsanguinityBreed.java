...
public class ConsanguinityBreed {
   ...
   public List<ConsanguinityBreedStatistics> getStatistics() {
      return statistics;
   }

   public void setStatistics(List<ConsanguinityBreedStatistics> statistics) {
      this.statistics = statistics;
   }

   public ConsanguinityBreed withId(int id) {
      this.setId(id);
      return this;
   }

   public ConsanguinityBreed withName(String name) {
      this.setName(name);
      return this;
   }

   public ConsanguinityBreed withStatistics(List<ConsanguinityBreedStatistics> statistics) {
