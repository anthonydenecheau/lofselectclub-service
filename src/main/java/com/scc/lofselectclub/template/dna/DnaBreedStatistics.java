...
public class DnaBreedStatistics {
	...
	public List<DnaVariety> getVariety() { return variety; }
	public void setVariety(List<DnaVariety> variety) { this.variety = variety; }

	public DnaBreedStatistics withYear(int year){ this.setYear(year); return this; }
	public DnaBreedStatistics withDna(int dna){ this.setDna(dna); return this; }
	public DnaBreedStatistics withDnaComp(int dnaComp){ this.setDnaComp(dnaComp); return this; }
	public DnaBreedStatistics withDnaCompP(int dnaCompP){ this.setDnaCompP(dnaCompP); return this; }
	public DnaBreedStatistics withDnaCompM(int dnaCompM){ this.setDnaCompM(dnaCompM); return this; }
	public DnaBreedStatistics withVariety(List<DnaVariety> variety){ this.setVariety(variety); return this; }
