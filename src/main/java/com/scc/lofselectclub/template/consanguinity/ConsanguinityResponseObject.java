...
public class ConsanguinityResponseObject {
	...
	public List<ConsanguinityBreed> getBreeds() { return breeds; }
	public void setBreeds(List<ConsanguinityBreed> breeds) { this.breeds = breeds; }

	public ConsanguinityResponseObject withSize(int size){ this.setSize(size); return this; }
	public ConsanguinityResponseObject withBreeds(List<ConsanguinityBreed> breeds){ this.setBreeds(breeds); return this; }
