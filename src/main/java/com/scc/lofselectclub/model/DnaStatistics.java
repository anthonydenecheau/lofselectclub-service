...
public class DnaStatistics extends GenericStatistics {
   ...
   public DnaStatistics(Integer idClub, String nomClub, Integer numClub, Integer idRace, String nomRace, String codeFci,
         Integer idVariete, String nomVariete, Integer dna, Integer dnaComp, Integer dnaCompP, Integer dnaCompM,
   ...
   public String toString() {
      return "BirthStatistics [idClub=" + idClub + ", nomClub=" + nomClub + ", numClub=" + numClub + ", idRace="
            ...
            + nomVariete + ", dna=" + dna + ", dnaComp=" + dnaComp + ", dnaCompP=" + dnaCompP + ", dnaCompM=" + dnaCompM
