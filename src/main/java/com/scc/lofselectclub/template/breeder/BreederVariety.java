...
public class BreederVariety {
   ...
   public BreederVarietyStatistics getStatistics() {
      return statistics;
   }

   public void setStatistics(BreederVarietyStatistics statistics) {
      this.statistics = statistics;
   }

   public BreederVariety withId(int id) {
      this.setId(id);
      return this;
   }

   public BreederVariety withName(String name) {
      this.setName(name);
      return this;
   }

   public BreederVariety withStatistics(BreederVarietyStatistics statistics) {
